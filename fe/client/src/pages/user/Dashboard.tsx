...
      try {
        // In a real app, you would fetch data for each grievance ID
        // For now, we use mock data that includes chat history
        const mockData: APIGrievance[] = [
           {
             "id": 123,
             "title": "Library AC not working",
             "description": "The air conditioning in the central library's main reading hall has been non-functional for the past three days. It's becoming very difficult for students to study.",
             "status": "IN_PROGRESS",
             ...
             "s3_doc_urls": [],
             "chat": [
               { "role": "admin", "message": "Your grievance has been received and assigned to the maintenance department.", "timestamp": "2025-10-17T08:30:00Z"},
               { "role": "student", "message": "Thank you. Could I get an estimated time for the fix?", "timestamp": "2025-10-17T09:15:22Z"},
               { "role": "admin", "message": "We have dispatched a team. They should be inspecting the unit within the next 2 hours. We will update you post-inspection.", "timestamp": "2025-10-17T09:45:10Z"}
             ]
           },
           {
             "id": 124,
             "title": "Mess food quality is poor",
             "description": "The quality of food served in the mess for dinner has been consistently bad. The rice is often undercooked and the curries are watery.",
             "status": "SOLVED",
             ...
             "chat": [
                { "role": "admin", "message": "We are looking into this with high priority.", "timestamp": "2025-10-02T11:00:00Z" }
             ],
             "rating": 4
           },
           {
             ...
             "description": "Internet connectivity in Hostel Block C has been down for over 24 hours. We are unable to attend online classes.",
             "status": "NEW",
           ...
           },
           {
             ...
             "description": "The student portal for course registration is showing a 500 error page. The deadline is tomorrow.",
             "status": "REJECTED",
             ...
             "chat": [
                 { "role": "admin", "message": "The registration deadline was extended by 3 days. This issue is now resolved.", "timestamp": "2025-09-28T12:00:00Z" }
             ]
           }
        ];
...
  }, []);
  ...
  const handleSendMessage = async () => {
    ...
    try {
        ...
        // const response = await fetch(`/grievances/${chatGrievance.id}/chat`, {
        //     method: 'POST',
        ...
        // For demonstration, we'll mimic the API response
        const newChatMessage: ChatMessage = {
            ...messagePayload,
            timestamp: new Date().toISOString()
        };

        // Update the grievances state to reflect the new message
        ...
        // Also update the currently open chat dialog
        setChatGrievance(prev => prev ? { ...prev, chat: [...(prev.chat || []), newChatMessage] } : null);
        setNewMessage('');
...
                          </Button>
                          <Button size="sm" variant="ghost" onClick={() => setChatGrievance(g)}>
